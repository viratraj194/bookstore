...
class UserForm(forms.ModelForm):
    ...
    conform_password = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'form-control' }), min_length=8)
...
class UserProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = UserProfile
        fields = ['profile_picture', 'cover_photo','country', 'state', 'city',
                  'pin_code']
